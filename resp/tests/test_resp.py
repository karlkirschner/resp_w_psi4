...
#     print('Unrestrained Electrostatic Potential Charges')
#     print(f'{np.around(charges[0], 5)}\n')

#     print('Restrained Electrostatic Potential (RESP) Charges')
#     print(f'{np.around(charges[1], 5)}\n')

#     print('Reference RESP Charges (via RED-III 5)')
#     print(f'{np.around(reference_charges, 5)}\n')

#     print('Difference')
#     print(f'{np.around(charges[1], 5)-np.around(reference_charges, 5)}\n')

#     assert np.allclose(np.around(charges[1], 5), np.around(reference_charges, 5), atol=1.5e-5)
